...
let pp = await this.profilePictureUrl(who, 'image').catch(_ => "https://qu.ax/tySBz.jpg")
...
let enlace = { contextInfo: { externalAdReply: {title: wm + 'ღ', body: 'support group' , sourceUrl: redesMenu, thumbnail: await(await fetch(gataMenu)).buffer() }}}
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '❀MomoAyaseBot Powered @Alba070503❀', thumbnailUrl: gataMenu, sourceUrl: accountsgb }}}
...
global.canalIdGB = ["120363198641161536@newsletter", "120363198641161536@newsletter", "120363198641161536@newsletter", "120363305941657414@newsletter"]
global.canalNombreGB = ["❀Alba070503-Channel❀", "❀Alba070503-Channel❀", "❀Alba070503-Channel❀", "❀Canal Test❀"]
...
global.img = 'https://qu.ax/RNNwV.jpg'
