...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `*✿❀Aqui Esta El Resultados❀✿*\n\n` } 
const smsAvisoAG = () => { return `*✿❀Ten Mucho Cuidado❀✿*\n\n` }
const smsAvisoIIG = () => { return `*✿❀Esta Es La Información❀✿*\n\n` }
const smsAvisoFG = () => { return `*✿❀La Bot Tiene Un Problema❀✿*\n\n` }
const smsAvisoMG = () => { return `*✿❀Este Comando Lo Uso Mal❀✿*\n\n` }
const smsAvisoEEG = () => { return `*✿❀La Bot Tiene Falla Reporte Con Su Creador Usando #report❀✿*\n\n` }
const smsAvisoEG = () => { return `*✿❀El Resultado Fue Exitoso❀✿*\n\n` }
...
const smsLista1 = () => { return `❀ Información De MomoAyaseBot-MD ❀`}
const smsLista2 = () => { return `❀ Creador/Owner ✿`}
const smsLista3 = () => { return `✿ Donar ✿`}
const smsLista4 = () => { return `❀ Velocidad ❀`}
const smsLista5 = () => { return `❀ Información Del Menu ❀`}
const smsLista6 = () => { return `❀ Menu Completo ❀`}
const smsLista7 = () => { return `❀ Instalar  MomoAyaseBot ❀`}
...
//_allantilink.js
const smsTextoYT = () => { return '❀MomoAyaseBot-MD❀ '} 
...
const smsPropban5 = () => { return `${lenguajeGB['smsAvisoEG']()}El Usuario Esta Baneado  ❀\nNo Podra Usar El ${gt}`}
